    ...
    const createPosts = new Promise((resolve, reject) => {
        ...
        resolve(
            graphql(`
                ...
                if (!result.data.allPost) {
                    return resolve()
                }

                const items = result.data.allPost.edges
    ...
    const createTags = new Promise((resolve, reject) => {
        ...
        resolve(
            graphql(`
                ...
                if (!result.data.allTag) {
                    return resolve()
                }

                const items = result.data.allTag.edges
    ...
    const createAuthors = new Promise((resolve, reject) => {
        ...
        resolve(
            graphql(`
                ...
                if (!result.data.allAuthor) {
                    return resolve()
                }

                const items = result.data.allAuthor.edges
                const postsPerPage = config.postsPerPage
    ...
    const createPages = new Promise((resolve, reject) => {
        ...
        resolve(
            graphql(`
                ...
                const items = result.data.allPage.edges
