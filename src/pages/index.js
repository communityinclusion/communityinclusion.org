      ...
      <HomeLayout location={location} title={siteTitle}>
        <section className="center infograph">
          <div className="row my-4 ">
            <div className="col-md-6 d-flex flex-column justify-content-between bg-white p-4">
              <h2 className="h4">
                The number of people with disabilities who work in competitive
                jobs is growing.
              </h2>
              <img
                src={emp_infograph}
                className="d-inline-block img-fluid align-middle"
                alt="Since 1988, Integrated Employment has increased people with disabilities hired for jobs by 325% (33,092 to 140,521)"
              />
            </div>
            <div className="col-md-6 d-flex flex-column justify-content-between bg-white p-4">
              <h2 className="h4">
                Career and technical education can improve post-school outcomes
                for students with disabilities.
              </h2>
              <img
                src={ed_infograph}
                className="d-inline-block align-middle img-fluid "
                alt="Individuals with intellectual disability who receive postsecondary ed are 2X more employable, make $406 more income, and require $77 less in SSI, per month"
              />
            </div>
          </div>
        </section>
        ...
        <section className="center AoS">
          ...
          <p className="fs-5 fw-bold">
            We offer actionable solutions that increase opportunities for people
            with disabilities to achieve employment in our competitive and
            vibrant economy.
          </p>
          <div className="row my-4 ">
            <div className="col-md-3 d-flex align-self-stretch bg-white p-1">
              <div className="card mb-2">
                <h3 className="fs-4  dark-blue text-center d-inline-block align-middle ps-2 fw-bold">
                  {" "}
                  We promote self-sufficiency.
                </h3>
                <div className="card-body d-flex flex-column px-0 pb-0">
                  <p className="lh-copy">
                    We study and publish the latest trends on employment &
                    economic self-sufficiency for people with intellectual
                    disabilities.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-3 d-flex align-self-stretch bg-white p-1">
              <div className="card mb-2">
                ...
                <div className="card-body d-flex flex-column px-0 pb-0">
                  <p>
                    All people want an opportunity to do paid work. Work is one
                    way people with disabilities contribute to their communities
                    and to the economy.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-3 d-flex align-self-stretch bg-white p-1">
              <div className="card mb-2">
                ...
                <div className="card-body d-flex flex-column px-0 pb-0">
                  <p>
                    Research has shown that people with disabilities are an
                    untapped, qualified resource in the labor market. Business
                    engagement is a key component in improving employment
                    outcomes.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-3 d-flex align-self-stretch bg-white p-1">
              <div className="card mb-2">
                <h3 className="fs-4 dark-blue d-inline-block align-middle ps-2 fw-bold">
                  {" "}
                  We are committed to academic excellence.
                </h3>
                <div className="card-body d-flex flex-column px-0 pb-0">
                  <p>
                    Our evidence-based research helps inform public policy at
                    the federal, state, and local levels to improve employment
        ...
        <section className="center">
          ...
          <p className="fs-5 fw-bold">
            We investigate real-world problems and challenges through our vast
            network of research projects, program evaluation, training,
            consultation, education, policy analysis, and service delivery.{" "}
          </p>
          <div className="row my-4 ">
            <div className="col-md-3 d-flex align-self-stretch bg-white p-1">
              <div className="card mb-2">
                ...
                <div className="card-body d-flex flex-column px-0 pb-0">
                  ...
                  <p className="mt-auto">
                    <Link to="/about/areas-of-emphasis/employment">
                      {" "}
            ...
            <div className="col-md-3 d-flex align-self-stretch bg-white p-1">
              <div className="card mb-2">
                ...
                <div className="card-body d-flex flex-column px-0 pb-0">
                  ...
                  <p className="mt-auto">
                    <Link to="/about/areas-of-emphasis/education">
                      {" "}
              ...
              <div className="card mb-2">
                ...
                <div className="card-body d-flex flex-column px-0 pb-0">
                  <p>
                    ...
                    satisfying life. Whether it's getting involved with a faith
                    community, attending a sports event, or volunteering at a
                    local charity, people with disabilities participate in their
                    community.
                  </p>
                  <p className="mt-auto">
                    <Link to="/about/areas-of-emphasis/community">
                      {" "}
              ...
              <div className="card mb-2">
                ...
                <div className="card-body d-flex flex-column px-0 pb-0">
                  <p>
                    ...
                    disabilities, adequate health care can require additional
                    advocacy and planning.
                  </p>
                  <p className="mt-auto">
                    <Link to="/about/areas-of-emphasis/healthcare">
                      {" "}
              ...
              <div className="card shadow-sm p-1">
                <div className="card-body">
                  <h4 className="card-title">
                    <a href="/projects/thinkwork">ThinkWork! </a>
                  </h4>
                  <p>
                    ThinkWork serves as the hub for an array of research,
                    training, and technical assistance efforts focused on
                    employment of people with intellectual and developmental
                    disabilities (IDD).
                  </p>
                </div>
              </div>
        ...
        <div className="row my-4 ">
          <div className="col-md-12 bg-white p-3">
            <p>
              {" "}
              <b>Our Mission:</b> The ICI at UMass Boston supports the rights of
              children and adults with disabilities to participate in all
              aspects of society. As practitioners, researchers, and teachers,
              we form partnerships with individuals, families, community
              organizations, and service agencies. Together, we advocate for
