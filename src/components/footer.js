      ...
      <div className="footer-top container-xxl	 px-3 text-white">
        <div className="row px-2-ns">
          <div className="col-md-4 col-sm-12 p-2 ">
            <h3 className="fs-4 border-bottom border-light py-0 lh-lg text-uppercase ">
              Contact
            </h3>
            <div className="d-inline-block-ns">
              <address>
                ...
                TTY: (617) 287-4350
                <br />
                Email: <a href="mailto:ici@umb.edu">ici@umb.edu</a>
                <br />
                &nbsp;
              </address>{" "}
            </div>
          ...
          <div className="col-md-4 col-sm-12 p-2 ">
            <h3 className="fs-4 border-bottom border-light pv-0 lh-lg text-uppercase">
              Links
            </h3>
            <ul className="align-middle w-100 w-75-l list pl0 list-unstyled">
              <li>
                ...
                <Link
                  to="/about/"
                  className="link  whited-inline-block"
                  title="About"
                >
                  About ICI
                </Link>
              ...
              <li>
                <Link
                  ...
                  className="link white d-inline-block"
              ...
              <li>
                {" "}
                <a
                  href="https://lp.constantcontactpages.com/su/jlCEExQ/subscribe"
                  className="link white d-inline-block"
                  target="_blank"
          ...
          <div className="col-md-4 col-sm-12 p-2 ">
            <h3 className="fs-4 border-bottom border-light w-100 py-0  lh-lg text-uppercase">
              Social
            </h3>
        ...
        <div className="row pt-3 gy-4">
          ...
          <div className="col-md-5 align-middle px-3">
            <p className="white small">
              {" "}
              &copy; {new Date().getFullYear()} The Institute for Community
              Inclusion was founded in 1967, and is a program at the University
              of Massachusetts Boston and Boston Children’s Hospital. The ICI is
              a University Center for Excellence in Developmental Disabilities,
              part of the national network started by President John F. Kennedy.
            </p>
          </div>
          ...
          <div className="col-md-3 v-mid px-3">
            <ul className="list-inline ">
              <li className="list-inline-item flex-fill pe-2 border-end border-light">
                <Link to="/about/privacy/" title="Privacy">
                  Privacy{" "}
                </Link>{" "}
              </li>
              <li className="list-inline-item flex-fill border-end border-light pe-2 ps-2">
                {" "}
                <Link to="/about/accessibility/" title="Accessibility">
                  Accessibility{" "}
                </Link>{" "}
              </li>
