      ...
      <div>
        {data.airtable.data.staff_photo && (
          <div className="staffphoto">
            <GatsbyImage
              image={
                data.airtable.data.staff_photo.localFiles[0].childImageSharp
                  .gatsbyImageData
              }
              alt=""
            />
        ...
        <h2 className=" fs-6 black-70 fw-light text-uppercase">
          {data.airtable.data.staff_title}
        </h2>
        ...
        <ul className="clearfix">
          {data.airtable.data.staff_email && (
            <li>
              <b>Email:</b>{" "}
              <a href={`mailto:${data.airtable.data.staff_email}`}>
                {data.airtable.data.staff_email}
              </a>{" "}
            </li>
          )}
          {data.airtable.data.staff_phone && (
            <li>
              <b>Phone:</b> {data.airtable.data.staff_phone}
            </li>
          )}
          ...
          {data.airtable.data.staff_link && (
            <li>
              <b>Link:</b>{" "}
              <a href={data.airtable.data.staff_link}>
                {data.airtable.data.staff_link}
              </a>
            </li>
          )}
