...
module.exports = {
  ...
  siteMetadata: {
    ...
    description:
      "ICI at UMass Boston supports the rights of children and adults with disabilities to participate in all aspects of society.",
    keywords: "Community Inclusion, UMB, Disabilities",
    twitterUsername: "@ICInclusion",
    author: "ICI at UMass Boston",
    image: "/ici_banner-lg.png",
    social: {
      twitter: `ICInclusion`,
    },
  },
        ...
        plugins: [
          {
            ...
            options: {
              theme: "Abyss",
              injectStyles: false, // Or install your favorite theme from GitHub
            },
          },
          {
              ...
              urlOverrides: [
                {
                  id: "wistia",
                  embedURL: (videoId) =>
                    `http://fast.wistia.net/embed/iframe/${videoId}`,
                },
              ],
        ...
        tables: [
          {
            ...
            mapping: {
              staff_photo: `fileNode`,
              staff_ed: `text/markdown`,
              staff_bio: `text/markdown`,
            },
